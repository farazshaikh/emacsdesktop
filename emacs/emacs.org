  ...
  (cond
   ...
   ((string-equal system-type "gnu/linux") ; linux
    (when (member "Source Code Pro" (font-family-list))
      (message "[INFO]: Font Linux Source Code Pro")
      (add-to-list 'initial-frame-alist '(font . "Source Code Pro"))
      (add-to-list 'default-frame-alist '(font . "Source Code Pro")))))

  ;; Over ride for bobcat
  (when (and (string-equal "bobcat" hostname) t)
    (add-to-list 'initial-frame-alist '(font . "Source Code Pro-15"))
    (add-to-list 'default-frame-alist '(font . "Source Code Pro-15")))

  ;;
  ;;(when (and (string-equal "unknown" hostname) t)
  ;;  (message "[INFO]: Font Linux Source Code Pro")
  ;;  (add-to-list 'initial-frame-alist '(font . "Source Code Pro-8"))
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package vertico-posframe
    ;;:disabled
    :quelpa (vertico-posframe
             :fetcher github
             :repo "tumashu/vertico-posframe/blob/main/vertico-posframe.el")
    :init
